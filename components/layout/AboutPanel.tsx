      ...
      >
        <div style={headerStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            <h2 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800 }}>{t('Site Hakkında', language)}</h2>
          </div>
        ...
        <div style={bodyStyle}>
          ...
          <div>
            <p style={{ margin: 0, fontSize: '1.1rem', color: 'var(--sidebar-text-primary)' }}>
              {t("Türkçe kelimelerin kökenlerini coğrafi ve tarihsel bir bağlamda keşfetmenizi sağlayan, açık kaynaklı modern bir veri görselleştirme projesidir. TDK ve diğer etimoloji kaynaklarından derlenen verilerle Türkçe'nin zenginliğini ve kelimelerinin yolculuğunu farklı bir yaklaşımla interaktif harita üzerinden öğrenilmesini amaçlar.", language)}
            </p>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '40px' }}>
              <div style={creditBoxStyle}>
                <span style={creditLabelStyle}>{t('Geliştirici', language)}</span>
                <span style={creditNameStyle}>Ömer ÖZKAN</span>
              </div>
              <div style={creditBoxStyle}>
                <span style={creditLabelStyle}>{t('Danışman', language)}</span>
